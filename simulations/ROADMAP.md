...
| **A2** | ~~B(E)?~~ **ANSWERED 2026-08-09 (D14): B falls with energy, shallowly.** 25 GeV B = 32.8 ± 2.4 ps vs 120 GeV B = 20.4 ± 5.8 ps; B ~ E^−0.15…−0.30. The gap's own stated expectation (B grows with E) was backwards. | **Energy is not a lever** — closing 28→10 ps would need ~3500 GeV, and real running is below 120 GeV, i.e. worse. | **Done** (7-rung 25 GeV ladder). |
